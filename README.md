# NixProject By Sotiris Zannetos
...
My MCU of choice is the ATmega328P which is a very popular choice that is also using in Arduino devices, it has a very well established documentation and support and can also be programmed using the Arduino IDE. This is exactly what I need as the Arduino IDE by itself is simple and easy to use and is also very well documented and supported by its community.
